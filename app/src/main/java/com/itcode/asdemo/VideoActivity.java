...
public class VideoActivity extends Activity {
    ...
    protected void onDestroy() {
        if(NATIVETEST) {
            ...
            mVideoEngineImp.destroyRenderView(glLocalSurfaceViewContainer.getSurfaceView());
            mVideoEngineImp.destroyRenderView(glRemoteSurfaceViewContainer.getSurfaceView());
            mVideoEngineImp.release();
        }
        NativeVoiceEngine.getInstance().requestLeavePlatformRoom();
        finish();
